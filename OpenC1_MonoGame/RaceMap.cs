...
namespace OpenC1
{
    class RaceMap
    {
        ...
        public RaceMap(Race race)
        {
            ...
            _player = OneAmEngine.Engine.ContentManager.Load<Texture2D>("map-icon-player");
            _opponent = OneAmEngine.Engine.ContentManager.Load<Texture2D>("map-icon-opponent");
            _deadOpponent = OneAmEngine.Engine.ContentManager.Load<Texture2D>("map-icon-opponent-dead");

            _mapRect = new Rectangle(0, 60, OneAmEngine.Engine.Window.Width, OneAmEngine.Engine.Window.Height - 90);
        }
        ...
        public void Render()
        {
            ...
            OneAmEngine.Engine.SpriteBatch.Draw(_mapTexture, _mapRect, new Color(255,255,255, 200));
            ...
            OneAmEngine.Engine.SpriteBatch.Draw(_player, new Vector2(translated.X, translated.Y), null, Color.White, rotation, new Vector2(8,8), 1f, SpriteEffects.None, 0);
            ...
            foreach (Opponent o in _race.Opponents)
            {
                ...
                OneAmEngine.Engine.SpriteBatch.Draw(o.IsDead ? _deadOpponent : _opponent,
