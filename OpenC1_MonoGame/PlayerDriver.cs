...
namespace OpenC1
{
    class PlayerDriver : IDriver
    {
        ...
        public PlayerDriver()
        {
            _audioListener = OneAmEngine.Engine.Audio.GetListener();
        ...
        public void Update()
        {
            ...
            if (OneAmEngine.Engine.Input.WasPressed(Keys.R))
            {
            ...
            if (OneAmEngine.Engine.Input.WasPressed(Keys.Back))
            {
                Vehicle.Repair();
            }
