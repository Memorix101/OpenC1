...
namespace OpenC1
{
    static class OpponentController
    {
        ...
        public static OpponentPathNode GetNodeCloseToPlayer()
        {
            ...
            int j = OneAmEngine.Engine.Random.Next(Nodes.Count);
            for (int i = 0; i < Nodes.Count; i++)
            {
                ...
                {
                    Nodes[j].LastUsedTime = OneAmEngine.Engine.TotalSeconds;
                    return Nodes[j];
                }
                j++;
                j %= Nodes.Count;
        ...
        {
            return Nodes[OneAmEngine.Engine.Random.Next(Nodes.Count)];
        }
        ...
        public static OpponentPath GetNextPath(OpponentPathNode currentNode)
        {
            ...
            int choosenPath = OneAmEngine.Engine.Random.Next(currentNode.Paths.Count);
            ...
            if (OneAmEngine.Engine.Random.Next() % 3 == 0)
            {
