...
namespace OpenC1.Screens
{
    ...
    class RaceOption : IMenuOption
    {
        ...
        public void RenderInSpriteBatch()
        {
            ...
            OneAmEngine.Engine.SpriteBatch.Draw(_scene, BaseHUDItem.ScaleVec2(0.23f, 0.19f), null, Color.White, 0, Vector2.Zero, 2, SpriteEffects.None, 1);
            OneAmEngine.Engine.SpriteBatch.DrawString(OneAmEngine.Engine.ContentManager.Load<SpriteFont>("LucidaConsole"), _info.Description, BaseHUDItem.ScaleVec2(0.54f, 0.19f), new Color(0, 220, 0), 0, Vector2.Zero, 1.2f, SpriteEffects.None, 1);
        }
