...
namespace OpenC1.Screens
{
    ...
    class RaceOption : IMenuOption
    {
        ...
        public void RenderInSpriteBatch()
        {
            ...
            GameEngine.SpriteBatch.DrawString(GameEngine.ContentManager.Load<SpriteFont>("LucidaConsole"), _info.Description, BaseHUDItem.ScaleVec2(0.54f, 0.19f), new Color(0, 220, 0), 0, Vector2.Zero, 1.2f, SpriteEffects.None, 1);
        }
