...
namespace OneAmEngine
{
    public class HeightmapTerrain
    {
        ...
        private void SetUpVertices()
        {
            ...
            vb = new VertexBuffer(Engine.Device, typeof(VertexPositionNormalTexture), vertices.Length * TILES_X * TILES_Z, BufferUsage.WriteOnly);
            vb.SetData(vertices);
        }
        ...
        public void Draw()
        {
            ...
            foreach (EffectPass pass in effect.CurrentTechnique.Passes)
            {
                ...
                Engine.Device.SetVertexBuffer(vb);
