...
namespace OneAmEngine
{
    public static class TextureGenerator
    {
        ...
        {
            Texture2D tex = new Texture2D(GameEngine.Device, 1, 1, false, SurfaceFormat.Color);
        ...
        {
            Texture2D tex = new Texture2D(GameEngine.Device, x, y, false, SurfaceFormat.Color);
