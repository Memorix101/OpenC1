...
namespace OpenC1.HUD
{
    abstract class BaseHUDItem
    {
        ...
        static BaseHUDItem()
        {
            ...
            _window = OneAmEngine.Engine.Window;
        ...
        {
            OneAmEngine.Engine.SpriteBatch.Draw(_shadow, rect, Color.White);
        }

        //protected void DrawString(SpriteFont font, string text, Vector2 position, Color color)
        //{
        //    OneAmEngine.Engine.SpriteBatch.DrawString(font, text, position, color, 0, Vector2.Zero, FontScale, SpriteEffects.None, 0);
        //}
    }
}
