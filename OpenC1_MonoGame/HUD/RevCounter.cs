...
namespace OpenC1.HUD
{
    class RevCounter: BaseHUDItem
    {
        ...
        {
            OneAmEngine.Engine.SpriteBatch.Draw(_speedoTexture, ScaleRect(x, y, 0.145f, 0.16f), Color.White);
            ...
            OneAmEngine.Engine.SpriteBatch.Draw(_speedoLineTexture, ScaleVec2(x + 0.07f, y + 0.09f),
